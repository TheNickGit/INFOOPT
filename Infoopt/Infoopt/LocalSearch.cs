...
class LocalSearch
{
    ...
    public static double
        ...
        startT = 0.05,          // Starting chance to accept worse outcomes
        T = startT,
        coolDownIts = 16000,    // Amount of iterations after which T*alpha happens
        reheat = 25_000_000,    // Reset T after this amount of iterations
        pCorrection = 4000,     // For adds and removes - Increase for more accepted adds/removes
        pCorrectionShift = 500, // For shifts - Increase for more accepted shifts
        pCorrectionSwap = 500;  // For swaps - Increase for more accepted swaps
    ...
    void TryAddOrder()
    {
        ...
        double p = Math.Exp(-totalCostChange / T / pCorrection);
        //Console.WriteLine("Cost change add: " + totalCostChange);
        ...
        if (totalCostChange < 0 || Program.random.NextDouble() < p)
        {
            ...
            adds++;
            //Console.WriteLine("Order freq " + order.freq + " added!");
        }
    }
    ...
    void TryRemoveOrder()
    {
        ...
        double p = Math.Exp(-totalCostChange / T / pCorrection);
        //Console.WriteLine("Cost change remove: " + totalCostChange);
    ...
    void TryShiftOrders()
    {
        ...
        //Console.WriteLine("Cost change shift: " + costChange);
    ...
    void TrySwapOrders()
    {
        ...
        //Console.WriteLine("Cost change swap: " + (costChange + costChange2));
        ...
        if (costChange + costChange2 < 0 || Program.random.NextDouble() <= p)
        {
            ...
            //DaySchedule.SwapOrders(
            //    (trip1, orderNode1, timeChange1, volumeChange1),
            //    (trip2, orderNode2, timeChange2, volumeChange2)
            //);
            swaps++;
        }
    }
